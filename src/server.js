...
If the id is automatically generated by MySQL, then you don't need to retrieve it from the request body in your Node.js code. You should adjust your SQL query to return the id of the newly inserted row, and then send that id back in the response. Here's how you can modify your Node.js code:
...
app.delete('/shops/delete/:shopId', (req, res) => {
  const shopId = req.params.shopId;
